...
# -----data related-----
data_root = '/home/livion/Documents/github/dataset/AIC22/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/AIC22_test.json'
train_data_prefix = ''  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/AIC22_test.json'
...
work_dir = 'work_dirs/yolov8x_DETRAC'
